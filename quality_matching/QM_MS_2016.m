...
cd('D:\MS-SEG-2016\registered_FLAIR');
subs = dir;
subs = subs(3:end);
...
for sub = 1:length(subs)
    ...
    path_flair = dir([folder,'\*FLAIR.nii.gz']);
    ...
    flair = flair(20:150,40:230,:); % decrease boarder
    ...
    seg = seg(20:150,40:230,:); % decrease boarder
